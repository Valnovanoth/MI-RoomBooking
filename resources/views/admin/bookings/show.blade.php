                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='time_from'>{{ implode('/', array_reverse(explode('-', strtok($booking->time_from, " ")))) }}</td>
                        </tr>
                        <!--
                        <tr>
                            <th>@lang('quickadmin.bookings.fields.time-to')</th>
                            <td field-key='time_to'>{{ implode('/', array_reverse(explode('-', strtok($booking->time_to, " ")))) }}</td>
                        </tr>
                        <tr>
